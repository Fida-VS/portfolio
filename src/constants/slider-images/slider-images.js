...
import mazeinfo from "./../../img/maze/mazeinfo2.png";
import tableInfo from "./../../img/prian-screens/table-info2.png";
import todoInfo from "./../../img/todo/spisokdelinfo2.png";
...
export const SLIDER_PRIAN_IMAGES = [
  [
    ...
    "authorization",
    "Таблица",
    "Тестовое задание - небольшое SPA-приложение, взаимодействующее с сервером. Реализованы страницы: авторизация и страница с таблицей, данные для которой получены с сервера. Можно взаимодействовать с таблицей - добавлять/редактировать/удалять записи. Изменения сразу отображаются в таблице. Данные для авторизации: логин - user{N}, где вместо N нужно ввести число, например user1, user2… user33. Пароль - password – одинаков для всех логинов.",
    "https://fida-vs.github.io/test-task-pryaniky/login",
    "https://github.com/Fida-VS/test-task-pryaniky",
  ],
